//RABSPSYD JOB (B4),'SEAVV',MSGCLASS=J,CLASS=E
//*
//*****************************************************************
//*   THIS JCL WILL BE SUBMITTED TO OUR JES2 READER FROM THE FTP 
//*   SERVER, SEAVVFTP.  THIS JOB CREATES A MESSAGE ON THE MVS
//*   CONSOLE TO ADVISE PRODUCTION SUPPORT THAT THE CANADA BSP 
//*   FILE WAS RETRIEVED FROM IINET AND DEMANDS IN JOB RABSPSYD.
//*****************************************************************
//*
//STEP0001 EXEC PGM=OP998ARP
//SYSIN  DD   *
  RABSPSYD SHOULD BEGIN PROCESSING.
/*
//*****************************************************************
//*   THE FOLLOWING STEP EXECUTES A CA7 COMMAND IN BATCH MODE;
//*   USUALLY USED FOR DEMANDING IN JOBS
//*****************************************************************
//BTERM EXEC BTIFACE
//SYSIN DD  DSN=CA7.BTI.CMND(LOGON),DISP=SHR
//      DD *
DEMAND,JOB=RABSPSYD,SCHID=2
/LOGOFF
/*              
//*                    
//*****************************************************************
...
//        PARM='+++ JOB RABSPSYD FAILED CONTACT PROD CONTROL +++'
//*
//
