//RABSPFRA JOB (B4),'SEAVV',MSGCLASS=J,CLASS=E
//*
//*****************************************************************
//*   THIS JCL WILL BE SUBMITTED TO OUR JES2 READER FROM THE FTP 
//*   SERVER, SEAVVFTP.  THIS JOB CREATES A MESSAGE ON THE MVS
//*   CONSOLE TO ADVISE PRODUCTION SUPPORT THAT THE GERMANY BSP 
//*   FILE WAS RETRIEVED FROM IINET AND DEMANDS IN JOB RABSPCAN.
//*****************************************************************
//*
//STEP0001 EXEC PGM=OP998ARP
//SYSIN  DD   *
  RABSPFRA SHOULD BEGIN PROCESSING.
/*
//*****************************************************************
...
//        PARM='+++ JOB RABSPFRA FAILED CONTACT PROD CONTROL +++'
//*
//
