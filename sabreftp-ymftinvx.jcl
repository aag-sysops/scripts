//YMFTINVX JOB (B4),'YM XMIT END',MSGCLASS=J,CLASS=P
//*
//**********************************************************************
...
//*
//*    DSN = PROD.YMRECEIV.RECEIVE.YLDDATA.COMP.VX
//*
...
//SYSIN  DD   *
MSG  THE VX YIELD MANAGEMENT DATA HAS ARRIVED FROM EDS.
MSG  YIELD MANAGEMENT PROCESS WILL RELEASE AT 00:05.
/*
//STEP0002 EXEC CA7SVC,PARM='D=YM.YMRECEIV.VX.SABRE.START,,1'
//*
//OPABEND  EXEC PROC=OPABEND,JOBNAME=YNMFTINVX
